...
def analyze(noise, last):
    ...
    cnoise = np.load(f'/h/nng/projects/OpenOOD/data/benchmark_imglist/cifar100/train_cifar100_{noise}.npy', allow_pickle=True).item()

    cmap = cnoise['cmap']
    labels = open('/h/nng/projects/OpenOOD/data/benchmark_imglist/cifar100/train_cifar100.txt').readlines()
    ...
    #print(roc_auc_score(rlabels, t1000_logp))a
    print('IF-COMP')
