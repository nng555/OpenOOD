...
python3 ${HDIR}/main.py --config ${HDIR}/configs/datasets/cifar10/cifar10_ood.yml \
  ...
  --postprocessor.postprocessor_args.argmax True \
  --postprocessor.postprocessor_args.damping 1e-12 \
  --postprocessor.postprocessor_args.jac_chunk_size 4 \
  --network.checkpoint /h/nng/slurm/2024-01-25/run_bash/${1}/results/cifar100_resnet18_32x32_base_e200_lr0.1_default/s10/best.ckpt ${@:2}
